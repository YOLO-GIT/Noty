  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        Noty is a simple yet powerful note-taking app designed to help you stay
        organized and productive. With Noty, you can easily create, edit, and
        organize your notes, whether it's for work, school, or personal use.
      </Text>
      ...
      <View style={styles.socialLinks}>
        ...
        <TouchableOpacity
          onPress={() => openSocialMedia("https://twitter.com/YOLO_LV9999999")}
        >
